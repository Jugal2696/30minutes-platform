...
// ✅ FIX: Use the new Cookie Client to read session correctly
...
export default function BusinessDashboard() {
  ...
  // ✅ FIX: Initialize Supabase with the Cookie Client
  ...
  async function init() {
    ...
    // 🛑 SECURITY CHECK: Redirect if cookie is missing
    if (!user) { 
        console.log("No user found in cookies, redirecting...");
    ...
    const recentMatches = (matches.data || []).slice(0, 5).map(m => ({
        ...
        link: '/dashboard/business/discover'
    }));
    ...
    const recentAgreements = (agreements.data || []).slice(0, 5).map(a => ({
        ...
        link: '/dashboard/business/agreements'
    }));
      ...
      <div className="max-w-7xl mx-auto px-6 py-8 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <KpiCard 
                ...
                sub="Score > 60%"
                action={() => window.location.href='/dashboard/business/discover'}
            />
            <KpiCard 
                ...
                sub="Action Required"
                action={() => window.location.href='/dashboard/business/inbox'}
            />
             <KpiCard 
                ...
                sub="In Progress"
                action={() => window.location.href='/dashboard/business/agreements'}
            />
            <KpiCard 
            ...
            <div className="lg:col-span-2 space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <ActionCard 
                        ...
                        link="/dashboard/business/preferences"
                    ...
                    <ActionCard 
                        ...
                        link="/dashboard/business/cobranding"
                        cta="Browse Partners"
                    />
                    <ActionCard 
                ...
                <Card>
                    <CardContent className="p-6 space-y-6">
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <span className={`text-sm font-bold ${business.co_branding_violation_count > 0 ? 'text-red-600' : 'text-green-600'}`}>
                                {business.co_branding_violation_count || 0}
                            </span>
                        </div>
                        ...
                        <div className="pt-4 border-t border-slate-100">
                             <div className="flex gap-3 items-center mb-2">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-slate-500">{business.legal_entity_name}</p>
                                </div>
                             </div>
                        </div>
                    </CardContent>
